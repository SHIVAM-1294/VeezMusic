...
@Client.on_message(
    command(["startop", f"start@{BOT_USERNAME}"]) & filters.private & ~filters.edited
)
...
@Client.on_message(
    command(["start", f"startop@{BOT_USERNAME}"]) & filters.group & ~filters.edited
)
...
@Client.on_message(
    command(["helpop", f"help@{BOT_USERNAME}"]) & filters.group & ~filters.edited
)
...
@Client.on_message(
    command(["helpop", f"helpop@{BOT_USERNAME}"]) & filters.private & ~filters.edited
)
